...
**Bio:** Cheuk Ting Li received the B.Sc. degree in mathematics and B.Eng. degree in information engineering from The Chinese University of Hong Kong, Hong Kong SAR, China, in 2012, and the M.S. and Ph.D. degree in electrical engineering from Stanford University, Stanford, USA, in 2014
...
**Abstract:** Deep learning has recently achieved remarkable success in lossy image compression. The so-called learned image compression (LIC) optimizes the rate-distortion performance for nonlinear transform, uniform scalar quantization, and entropy modeling in an end-to-end fashion but fails to shed light on the rate-distortion optimization in analogy to traditional transform coding. In this talk, I will present our recent works on rate-distortion optimization for learned image compression from the perspectives of non-linear transform, quantization, and entropy modeling. I will begin with a nonlinear transform via reversible autoencoder that enables invertible mapping between the (input) pixel domain and latent (representation) domain and guarantee the stability of nonlinear transform under down-sampling and up-sampling. The invertible nonlinear transform then inspires the analytic rate-distortion model to guide the scalar quantization for allowing variable-rate LIC and realizing precise rate control. Furthermore, analytic rate-distortion optimization is extended to achieve embedded quantization on latent representation with dead-zone quantizer for learned progressive coding. Finally, I will introduce our attempts on generative probabilistic entropy modeling of the distribution of latent representation for accurate rate estimation.

**Bio:** Wenrui Dai received B.S., M.S., and Ph.D. degree in Electronic Engineering from Shanghai Jiao Tong University, Shanghai, China in 2005, 2008, and 2014. He is currently an associate professor at the Department of Computer Science and Engineering, Shanghai Jiao Tong University (SJTU). Before joining SJTU, he was with the faculty of the University of Texas Health Science Center at Houston from 2018 to 2019. He was a postdoctoral scholar with the Department of Biomedical Informatics, University of California, San Diego from 2015 to 2018 and a postdoctoral scholar with the Department of Computer Science and Engineering, SJTU from 2014 to 2015. His research interests include multimedia signal processing and machine learning. He has published more than 140 papers, including over 40 IEEE Transactions and 36 prestigious conference papers like ICML, NeurIPS, and CVPR. He was the co-author of a Top Paper Award in ACM Multimedia 2022. He was the recipient of Young Top-notch Talent of the national Ten Thousand Talent Program in 2023.
